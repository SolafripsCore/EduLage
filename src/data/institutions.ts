...
export const institutions: Institution[] = [
  ...
  {
    id: "inst-unia",
    slug: "pilot-university-a",
    name: "Pilot University A",
    shortName: "UNIA",
    city: "Lagos",
    country: "Nigeria",
    countryCode: "NG",
    region: "Africa",
    founded: 2026,
    accreditationBody: "EduLage pilot programme",
    accreditationStatus: "Pilot",
    tenantStatus: "active",
    about:
      "Pilot tenant used to validate open enrolment, payments and learning delivery on the EduLage platform before institutions go live.",
    admissionsPortalUrl: "https://unia.learn.edulage.org",
    accent: "#0e8e73",
    logo: "/brand/edulage-mark-512.png",
    campusImage: "/media/campus-africa-west.jpg",
  },
  {
    id: "inst-unib",
    slug: "pilot-university-b",
    name: "Pilot University B",
    shortName: "UNIB",
    city: "Abuja",
    country: "Nigeria",
    countryCode: "NG",
    ...
    tenantStatus: "active",
    about:
      "Second pilot tenant used to verify institution isolation, admission-gated programmes and payment records per institution.",
    admissionsPortalUrl: "https://unib.learn.edulage.org",
    accent: "#14265f",
    logo: "/brand/edulage-mark-512.png",
    campusImage: "/media/campus-africa-west.jpg",
  },
