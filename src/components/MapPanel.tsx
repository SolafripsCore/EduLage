export function MapPanel() {
  return <div className="relative min-h-[340px] overflow-hidden rounded-lg border border-navy-700 bg-navy-800 p-5">
    <svg viewBox="0 0 520 340" className="absolute inset-0 h-full w-full opacity-70" aria-label="Illustrative network map of Global Open Education Centers (GOE Centers)" role="img">
