...
export function Button({ children, variant = "primary", className = "", href, ...props }: ButtonProps) {
  ...
  const classes = `inline-flex items-center justify-center gap-2 rounded-md border px-4 py-2.5 text-sm font-semibold focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 ${styles} ${className}`;
